...
||Intro Thomas|I am Freelance Full Stack Engineer and Architect. I have worked for companies like Symantec, Actian and McLaren to name just a few. So I have been writing Software since 2004 and I specialised on web technologies since 2011, primarily focused on the Microsoft Stack and Angular. I enjoy being hands-on and plan to always remain hands on but I'm looking to focus more on the Archtecture and mentoring/consulting side of things. I'm a certified Azure Architect and also a cat person. You can find me on twitter/github and linkedin by searching for tkglaser.|Thomas|2m|
